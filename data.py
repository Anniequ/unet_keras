...
def trainGenerator(batch_size, train_path, image_folder, mask_folder, aug_dict, image_color_mode="grayscale",
                   ...
                   flag_multi_class=False, num_class=2, save_to_dir=None, target_size=( 576, 720), seed=1):
    """
...
def testGenerator(test_path, num_image=30, target_size=(576, 720), flag_multi_class=False, as_gray=True):
